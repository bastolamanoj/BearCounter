...
import ShakeableView from '../components/ShakeableView';
...
const getFormattedDate = () => {
  ...
  const month1 = new Intl.DateTimeFormat('en-US', { month: 'short' }).format(today);  // E.g., "September"
